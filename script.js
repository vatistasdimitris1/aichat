...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const helpButton = document.getElementById("help-button"); // Add reference to the Help button
    const commandList = document.getElementById("command-list"); // Add reference to the command list
